...
prepare-etc-makefile:
	...
	@sed -e "s:\(VERSION=\).*:\1$(VERSION):g" lib/exceptions/Makefile.in > lib/exceptions/Makefile.tmp
	@mv lib/exceptions/Makefile.tmp lib/exceptions/Makefile
